...
<script>
    ...
    function mostrarBotaoInstalacao() {
        ...
        btn.style.cssText = `
            ...
            font-weight: 600;
            cursor: pointer;
            box-shadow: 0 4px 15px rgba(214,25,53,0.4);
            z-index: 9999;
            animation: pulse 2s infinite;
            display: flex;
            align-items: center;
        ...
        style.textContent = `
            @keyframes pulse {
                0% { transform: scale(1); box-shadow: 0 4px 15px rgba(214,25,53,0.4); }
                50% { transform: scale(1.05); box-shadow: 0 6px 25px rgba(214,25,53,0.6); }
                100% { transform: scale(1); box-shadow: 0 4px 15px rgba(214,25,53,0.4); }
            }
        `;
        document.head.appendChild(style);
        document.body.appendChild(btn);
