        ...
        <div class="navbar">
            <div class="logo-area">
                <a href="#inicio" style="display:flex;align-items:center;text-decoration:none;">
                    <img src="/assets/images/logo/ferrobrasmetais_logo.webp" alt="Ferrobras Metais" class="brand-logo" width="200" height="105" loading="lazy">
                </a>
            </div>
            <ul class="nav-links">
                ...
                <?php foreach($produtos as $produto): ?>
                    ...
                    <div class="product-card">
                        <?php if($img_encontrada): ?>
                            <img src="<?php echo $img_final; ?>" alt="<?php echo htmlspecialchars($produto['nome']); ?>" class="product-image" loading="lazy" width="400" height="200">
                        <?php else: ?>
